...
public class Sitz3
{
	...
	public void drawsitz3(){
		drawSitz3();
	}
	
	private void drawSitz3()
	{ 

	    glPushMatrix();
	    	glTranslatef(-1, 89, 75);
	    	glRotatef(90, 0, 1, 0);
	...
	private void drawSeite(){
	    ...
	    float xa=0, xe=75, ya=0, ye=10; // unterer linker und oberer rechter Eckpunkt des darzustellenden Rechtecks
