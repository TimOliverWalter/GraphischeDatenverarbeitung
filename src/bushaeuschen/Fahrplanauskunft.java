...
public class Fahrplanauskunft
{
	// private Variablen
	
	public void drawfahrplanauskunft(){
		drawFahrplanauskunft();
	}
	
	private void drawFahrplanauskunft()
	{ 
		

		glPushMatrix();
			glTranslatef(582, 150, 0);
			drawSeite(); 
		glPopMatrix();
	...
	private void drawSeite(){
	    ...
	    float xa=0, xe=70, ya=0, ye=100; // unterer linker und oberer rechter Eckpunkt des darzustellenden Rechtecks
